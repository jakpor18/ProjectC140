...
function askBot() {
                ...
                contentType: 'application/json',
                    success: function (result) {
                       ...
                       $('.chatbox_messages_container').animate({
                           scrollTop: $('.chatbox_messages_container')[0].scrollHeight},1000);
                    },
                    error: function (result) {
                       alert(result.responseJSON.message)   
                    }
    ...
    $('#bot_input_text').keypress(function(e){
        //If Enter key(key code is 13) pressed the letter e is a callback function. (13)If you press the enter button 
        if(e.which ==13){         
